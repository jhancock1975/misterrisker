"""Custom exceptions for Schwab MCP Server."""


class SchwabAPIError(Exception):
    """Exception raised for Schwab API errors.
    
    Attributes:
        message: Error message describing what went wrong
        status_code: HTTP status code from the API response (optional)
        error_code: Schwab-specific error code (optional)
    """
    ...
    def __init__(
        ...
        """Initialize SchwabAPIError.
        
        Args:
            message: Error message
            status_code: HTTP status code
            error_code: Schwab-specific error code
        """
