...
the schwab apis have functions for returning large amounts of historical data for stocks, options, 

the coinbase apis have functions for returning large amount of historical data crypto currency and perpetual crypto
